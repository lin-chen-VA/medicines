function rotamerPlot(res_1, res_2, xRange, resName, binSize)
    ...
    % and EM
    % res_1, csv file of X-Ray containing X-Ray data
    % res_2, csv file of EM containing EM data
    % xRange, display range of distance
    % resName, residue name
    % binSize, distance bin size
    % For example:
    %       compareAll('X-RayR_1.5/ARG.csv', 'EM_3.5_4.0/ARG.csv', 2:0.05:7, 'ARG', 0.05)
    % read matrix
